...
import { MessageCircle, Share2, Globe, Mail, Phone, Trophy} from "lucide-react";
import { SponsorLogo } from "@/components/tournament-home/SponsorLogo";
    ...
    <footer className="bg-slate-900 text-slate-300 font-sans border-t border-slate-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
          ...
          <div className="flex flex-col gap-4">
            <Link to="/" className="flex items-center gap-3">
              ...
              <span className="font-extrabold text-2xl text-white tracking-tight">Hệ thống quản lý giải đấu</span>
            </Link>
            <p className="text-sm text-slate-400 leading-relaxed max-w-sm mt-2">
              Nền tảng quản lý và tổ chức giải đấu thể thao chuyên nghiệp.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-3 text-sm text-slate-400">
                ...
                <span className="hover:text-white transition-colors cursor-pointer">support@ptscsupplybase.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm text-slate-400">
      ...
      <div className="bg-slate-950/50 border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs font-semibold text-slate-500">© 2026 PTSC Supply Base. All rights reserved.</p>
