...
import type { TeamState } from "../types/store";
...
export const useTeamStore = create<TeamState>((set, get) => ({
    ...
    createTeam: async (data) => {
        ...
        try {
            ...
            const msg = err instanceof Error ? err.message : "Tạo đội thất bại";
            set({ error: msg });
            toast.error(msg);
        } finally {
            set({ loading: false });
    ...
    updateTeam: async (teamId, data) => {
        ...
        try {
            ...
            if (get().currentTeam?._id === teamId) {
                set({ currentTeam: { ...get().currentTeam!, ...data } as Team });
            }
            await get().getUserTeams();
        } catch (err: unknown) {
            const msg = err instanceof Error ? err.message : "Cập nhật đội thất bại";
            set({ error: msg });
            toast.error(msg);
        } finally {
            set({ loading: false });
    ...
    deleteTeam: async (teamId) => {
        ...
        try {
            ...
            if (get().currentTeam?._id === teamId) set({ currentTeam: null });
            await get().getUserTeams();
        } catch (err: unknown) {
            const msg = err instanceof Error ? err.message : "Xóa đội thất bại";
            set({ error: msg });
            toast.error(msg);
        } finally {
            set({ loading: false });
    ...
    getUserTeams: async () => {
        ...
        try {
            ...
            const msg = err instanceof Error ? err.message : "Lấy danh sách đội thất bại";
            set({ error: msg });
            toast.error(msg);
        } finally {
            set({ loading: false });
    ...
    getTeamDetail: async (teamId) => {
        ...
        try {
            ...
            const msg = err instanceof Error ? err.message : "Lấy chi tiết đội thất bại";
            set({ error: msg });
            toast.error(msg);
        } finally {
            set({ loading: false });
    ...
    getTeamsByTournament: async (tournamentId, status) => {
        ...
        try {
            ...
            const msg = err instanceof Error ? err.message : "Lấy danh sách đội theo giải thất bại";
            set({ error: msg });
            toast.error(msg);
        } finally {
            set({ loading: false });
    ...
    leaveTeam: async (teamId) => {
        ...
        try {
            ...
            const msg = err instanceof Error ? err.message : "Rời đội thất bại";
            set({ error: msg });
            toast.error(msg);
        } finally {
            set({ loading: false });
    ...
    transferCaptaincy: async (teamId, newCaptainUserId) => {
        ...
        try {
            ...
            const msg = err instanceof Error ? err.message : "Chuyển quyền đội trưởng thất bại";
            set({ error: msg });
            toast.error(msg);
        } finally {
            set({ loading: false });
    ...
    getUserInvitations: async () => {
        ...
        try {
            ...
            const msg = err instanceof Error ? err.message : "Lấy danh sách lời mời thất bại";
            set({ error: msg });
            toast.error(msg);
        } finally {
            set({ loading: false });
    ...
    getTeamJoinRequests: async (teamId) => {
        ...
        try {
            ...
            const msg = err instanceof Error ? err.message : "Lấy danh sách yêu cầu thất bại";
            set({ error: msg });
            toast.error(msg);
        } finally {
            set({ loading: false });
    ...
    approveJoinRequest: async (requestId) => {
        ...
        try {
            ...
            const currentTeamId = get().currentTeam?._id;
            if (currentTeamId) {
                await get().getTeamJoinRequests(currentTeamId);
                await get().getTeamDetail(currentTeamId);
            }
        } catch (err: unknown) {
            const msg = err instanceof Error ? err.message : "Duyệt yêu cầu thất bại";
            set({ error: msg });
            toast.error(msg);
        } finally {
            set({ loading: false });
    ...
    rejectJoinRequest: async (requestId) => {
        ...
        try {
            ...
            const msg = err instanceof Error ? err.message : "Từ chối yêu cầu thất bại";
            set({ error: msg });
            toast.error(msg);
        } finally {
            set({ loading: false });
    ...
    updatePaymentStatus: async (teamId, isPaid) => {
        ...
        try {
            ...
            if (get().currentTeam?._id === teamId) {
                set({ currentTeam: { ...get().currentTeam!, isPaid } as Team });
            }
        } catch (err: unknown) {
            const msg = err instanceof Error ? err.message : "Cập nhật thanh toán thất bại";
            set({ error: msg });
            toast.error(msg);
        } finally {
            set({ loading: false });
    ...
    searchUsers: async (keyword) => {
        ...
        try {
            ...
            const msg = err instanceof Error ? err.message : "Tìm kiếm người dùng thất bại";
            set({ error: msg });
            toast.error(msg);
            return [];
        } finally {
    ...
    registerFlow: async (data) => {
        ...
        try {
            ...
            const msg = err instanceof Error ? err.message : "Đăng ký giải đấu thất bại";
            set({ error: msg });
            toast.error(msg);
            throw err;
        } finally {
